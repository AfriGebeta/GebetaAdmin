  ...
  return (
    <div className='bg-secondary w-[70px] md:w-[250px] sm:w-[200px] h-screen fixed pt-4 pl-2 pr-2 pb-4 sm:p-6 flex flex-col gap-3'>
        ...
        <div>
            ...
            <div className='bg-secondary bg-shadedGrey pl-4 overflow-hidden rounded-[10px]'>
                <ul className='flex flex-col gap-2'>
                    ...
                    <li>
                        <a href="#" className='flex gap-2 hover:text-primary hover:scale-105 active:scale-90 focus:scale-90 focus:text-primary'>
                            <img src={ClientMgmt} alt="" className='w-[25px] h-[25px]' />
                    ...
                    <li>
                        <a href="#" className='flex gap-2 hover:text-primary hover:scale-105 active:scale-90 focus:scale-90 focus:text-primary'>
                            <img src={ApiKey} alt="" className='w-[25px] h-[25px]' />
                    ...
                    <li>
                         <a href="#" className='flex gap-2 hover:text-primary hover:scale-105 active:scale-90 focus:scale-90 focus:text-primary'>
                            <img src={Newsletter} alt="" className='w-[25px] h-[25px]' />
        ...
        <div>
            ...
            <div className='bg-secondary bg-shadedGrey pl-4 overflow-hidden rounded-[10px]'>
                <ul className='flex flex-col gap-2'>
                    ...
                    <li>
                        <a href="#" className='flex gap-2 hover:text-primary hover:scale-105 active:scale-90 focus:scale-90 focus:text-primary'>
                            <img src={OngoingProjects} alt="" className='w-[25px] h-[25px]' />
                    ...
                    <li>
                        <a href="#" className='flex gap-2 hover:text-primary hover:scale-105 active:scale-90 focus:scale-90 focus:text-primary'>
                            <img src={Meetings} alt="" className='w-[25px] h-[25px]' />
                    ...
                    <li>
                        <a href="#" className='flex gap-2 hover:text-primary hover:scale-105 active:scale-90 focus:scale-90 focus:text-primary'>
                            <img src={Basket} alt="" className='w-[25px] h-[25px]' />
        ...
        <div className='bottom-6 fixed'>
            <a href="#" className='flex gap-2 hover:text-primary hover:scale-105 active:scale-90 focus:scale-90 focus:text-primary'>
                <img src={Logout} alt="" className='w-[30px] h-[30px]' />
