        ...
        <div>
            ...
            <div className=' bg-shadedGrey pl-4 pb-2 pt-2 overflow-hidden rounded-[7px]'>
                <ul className='flex flex-col gap-2'>
                    {/* Home */}
                    <li>
                        <Link to={"/dashboard/usage"} className='flex gap-2 hover:text-primary hover:scale-105 active:scale-90 focus:scale-90 focus:text-primary'>
                    ...
                    {/* Client Management */}
                    <li>
                        <Link to={"/dashboard/clientmanagement" }className='flex gap-2 hover:text-primary hover:scale-105 active:scale-90 focus:scale-90 focus:text-primary'>
                    ...
                    {/* API Keys */}
                    <li>
                        <Link to={"/dashboard/apikeys"} className='flex gap-2 hover:text-primary hover:scale-105 active:scale-90 focus:scale-90 focus:text-primary'>
                    ...
                    {/* Activities */}
                    <li>
                        <Link to={"/dashboard/activities"} className='flex gap-2 hover:text-primary hover:scale-105 active:scale-90 focus:scale-90 focus:text-primary'>
